package io.jubilee.AG001SpringJpa;
...
import io.jubilee.AG001SpringJpa.domain.Owner;
import io.jubilee.AG001SpringJpa.domain.OwnerRepository;
import io.jubilee.AG001SpringJpa.domain.Vehicle;
import io.jubilee.AG001SpringJpa.domain.VehicleRepository;
import io.jubilee.AG001SpringJpa.domain.Driver;
import io.jubilee.AG001SpringJpa.domain.DriverRepository;

@SpringBootApplication
public class Ag001SpringJpaApplication implements CommandLineRunner {

	private static final Logger logger = LoggerFactory.getLogger(Ag001SpringJpaApplication.class);
	private final VehicleRepository repository;
	private final OwnerRepository ownerRepository;
	private final DriverRepository driverRepository;
		
//	public Ag001SpringJpaApplication() {
...
//	}
	...
	public static void main(String[] args) {
		SpringApplication.run(Ag001SpringJpaApplication.class, args);
